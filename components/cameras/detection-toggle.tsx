      ...
      <Tooltip>
        <TooltipTrigger asChild>
          <Button
            ...
            size={size}
            variant={variant}
            className="relative glass transition-all duration-300 btn-pulse"
          >
            {isLoading ? (
            ...
            {isDetectionActive && (
              <motion.span
                ...
                style={{ boxShadow: "0 0 0 rgba(34, 197, 94, 0.7)" }}
              >
                <motion.span
...
export function CameraDetectionToggle({
  ...
  return (
    <Button
      ...
      variant="outline"
      className={`
        glass transition-all duration-300 flex items-center gap-2 btn-pulse
    ...
    >
      ...
      {isDetectionEnabled && (
        <motion.span initial={{ scale: 0 }} animate={{ scale: 1 }} className="h-2 w-2 rounded-full bg-green-500">
          <motion.span
            className="absolute inset-0 rounded-full bg-green-500"
            animate={{
              scale: [1, 1.5, 1],
